...
type AddRequest struct {
	...
	X int32 `protobuf:"varint,1,opt,name=x,proto3" json:"x,omitempty"` // Unique ID number for X
	Y int32 `protobuf:"varint,2,opt,name=y,proto3" json:"y,omitempty"` // Unique ID number for Y
}
...
type AddResponse struct {
	...
	Result int32 `protobuf:"varint,1,opt,name=result,proto3" json:"result,omitempty"` // Unique ID number for result
}
...
var file_api_proto_adder_proto_rawDesc = []byte{
	...
	0x2f, 0x6e, 0x61, 0x79, 0x61, 0x6e, 0x39, 0x32, 0x32, 0x39, 0x2f, 0x67, 0x6f, 0x47, 0x72, 0x70,
